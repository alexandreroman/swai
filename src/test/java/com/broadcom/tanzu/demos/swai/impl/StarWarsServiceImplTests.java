...
class StarWarsServiceImplTests {
    @Autowired
    private StarWarsService sws;
    ...
    void testFindFilms() {
        ...
        final var films = sws.findFilms();
        final var expectedFilms = List.of(
                new Film(1, "A New Hope", 4, LocalDate.of(1977, 5, 25)),
                new Film(2, "The Empire Strikes Back", 5, LocalDate.of(1980, 5, 17)),
                new Film(3, "Return of the Jedi", 6, LocalDate.of(1983, 5, 25)),
                new Film(4, "The Phantom Menace", 1, LocalDate.of(1999, 5, 19)),
                new Film(5, "Attack of the Clones", 2, LocalDate.of(2002, 5, 16)),
                new Film(6, "Revenge of the Sith", 3, LocalDate.of(2005, 5, 19))
        );
        assertThat(films).isNotEmpty();
        assertThat(films).containsExactlyInAnyOrderElementsOf(expectedFilms);
    }

    @Test
    void testFindPlanetsByFilm() {
        ...
        stubFor(get(urlEqualTo("/planets/1"))
                .willReturn(aResponse().withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("""
                                ...
                                """)));
        stubFor(get(urlEqualTo("/planets/2"))
                .willReturn(aResponse().withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("""
                                {
                                   "name":"Alderaan",
        ...
        final var planets = sws.findPlanetsByFilm(1);
        final var expectedPlanets = List.of(
                new Planet(1, "Tatooine", "200000"),
                new Planet(2, "Alderaan", "2000000000")
        );
    ...
    void testFindCharactersByFilm() {
        ...
        stubFor(get(urlEqualTo("/people/1"))
                .willReturn(aResponse().withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("""
                                ...
                                """)));
        stubFor(get(urlEqualTo("/people/2"))
                .willReturn(aResponse().withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("""
                                {
                                   "name":"C-3PO",
        ...
        final var characters = sws.findCharactersByFilm(1);
        final var expectedCharacters = List.of(
                new People(1, "Luke Skywalker", new Planet(1, "Tatooine", "200000")),
                new People(2, "C-3PO", new Planet(1, "Tatooine", "200000"))
        );
        assertThat(characters).isNotEmpty();
        assertThat(characters).containsExactlyInAnyOrderElementsOf(expectedCharacters);
    }

    @Test
    void testFindResidentsByPlanet() {
        stubFor(get(urlEqualTo("/people/1"))
                .willReturn(aResponse().withHeader("Content-Type", MediaType.APPLICATION_JSON_VALUE)
                        .withBody("""
                                {
        ...
        final var residents = sws.findResidentsByPlanet(1);
        final var expectedResidents = List.of(
                new People(1, "Luke Skywalker", new Planet(1, "Tatooine", "200000")),
                new People(2, "C-3PO", new Planet(1, "Tatooine", "200000"))
        );
        assertThat(residents).isNotEmpty();
        assertThat(residents).containsExactlyInAnyOrderElementsOf(expectedResidents);
    }

    @Test
    void testFindPlanets() {
        ...
        final var planets = sws.findPlanets();
        final var expectedPlanets = List.of(
                new Planet(1, "Tatooine", "200000"),
                new Planet(2, "Alderaan", "2000000000")
        );
